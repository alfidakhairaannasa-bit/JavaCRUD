...
*Tujuan Program*
1. Mengelola data siswa secara digital.
2. Menerapkan konsep CRUD pada Java.
3. Menghubungkan aplikasi Java dengan database MySQL.
...
Dengan adanya aplikasi ini, proses pengelolaan data siswa dapat dilakukan secara lebih cepat, mudah, dan terstruktur.
